...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-add-product" method="POST" action="{{route('product.variant.add',['productID' => $productID])}}">
                @csrf
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="size_id">
                                ...
                                <option value="{{$size->sizeID}}" {{ old('size_id') == $size->sizeID ? 'selected' : '' }}>
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="color_id">
                                ...
                                <option value="{{$color->colorID}}" {{ old('color_id') == $color->colorID ? 'selected' : '' }}>
                ...
                <div class="gap10 mt-5">
                    <button class="tf-button w-25" type="submit">Thêm</button>
                </div>
