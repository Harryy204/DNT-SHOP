...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('product.size.update',['sizeID' => $size->sizeID])}}" method="POST">
                @csrf
                @method('PUT')
                <fieldset class="name">
                    ...
                    <input class="flex-grow @error('size_name') border-danger @enderror" type="text" placeholder="Tên kích thước" name="size_name"
                        tabindex="0" value="{{old('size_name',$size->size_name)}}" aria-required="true">
                </fieldset>
                <fieldset>
                    <div></div>
