    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <button class="tf-button style-1 w208" onclick="history.back()">Quay lại</button>
            </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="pname">
                                <div class="image">
                                    <img src="{{$orderDetail->product_variant->products->images[0]->image_url}}" alt="" class="image">
                                </div>
                                <div class="name">
                                    <a href="#" target="_blank"
                                        class="body-title-2">{{$orderDetail->product_variant->products->product_name}}</a>
                                </div>
                            </td>
        ...
        <div class="wg-box mt-5">
            ...
            <div class="my-account__address-item col-md-6">
                <div class="my-account__address-item__detail">
                    <p>Họ tên người nhận: {{$order->user->full_name ?? 'Khách hàng đã bị xóa'}}</p>
                    <br>
                    <p>Địa chỉ nhận hàng: {{$order->user->address ?? 'Khách hàng đã bị xóa'}}</p>
                    <br>
                    <p>Số điện thoại : {{$order->user->phone ?? 'Khách hàng đã bị xóa'}}</p>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered table-transaction">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="5">{{number_price($order->total_amount)}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
